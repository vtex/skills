# AGENTS.md — Payment Connector Development

These instructions guide AI agents working on VTEX Payment Connector Development tasks.
...
- POS / VTEX Sales App card-present payments, where Gateway `card` fields are null — use [`payment-ppp-pos`](../payment-ppp-pos/skill.md)
...
- [`payment-ppp-pos`](../payment-ppp-pos/skill.md) — POS card-present payments; Gateway `card` is null and Secure Proxy does not apply
...
| Companion | Load when |
|---|---|
| [generation.md](payment-ppp-pos/references/generation.md) | The user asked to **create** a POS connector. Ask the four questions, then implement in the listed order. |
| [ppf-scaffold.md](payment-ppp-pos/references/ppf-scaffold.md) | Hosting is **VTEX IO / PPF**. Copy overlay files onto the official PPF example app. |
| [examples.md](payment-ppp-pos/references/examples.md) | You need expected JSON, the state machine table, or IO retry vs standalone notification. |
...
The next `authorize()` MUST return `status`, `cardBrand`, `firstDigits`, and `lastDigits` from the persisted record. See [examples.md](payment-ppp-pos/references/examples.md) for the standalone notification payload.
...
Follow [generation.md](payment-ppp-pos/references/generation.md) in order. For PPF, overlay POS on the official example app from the [Payment Provider Framework](https://developers.vtex.com/docs/guides/payments-integration-payment-provider-framework) guide using [ppf-scaffold.md](payment-ppp-pos/references/ppf-scaffold.md). Compare IO vs standalone payloads in [examples.md](payment-ppp-pos/references/examples.md).
...
- [generation.md](payment-ppp-pos/references/generation.md) — Questions to ask, clone-the-example workflow, implementation order
- [ppf-scaffold.md](payment-ppp-pos/references/ppf-scaffold.md) — Overlay files for the official PPF example app
- [examples.md](payment-ppp-pos/references/examples.md) — Partner prompts and IO vs standalone payloads
