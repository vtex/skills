...
- [`vtex-io-storefront-theme-versioning`](vtex-io-vtex-io-storefront-theme-versioning.md) — Use when the app declares the `store` builder and a version change must preserve or migrate Site Editor content.
- [`vtex-io-storefront-theme-app`](vtex-io-vtex-io-storefront-theme-app.md) — Use when the question is what the theme app's `store/` files should own.
...
- [vtex-io-app-contract](vtex-io-vtex-io-app-contract.md) — Manifest, policies
...
- [`vtex-io-auth-and-policies`](vtex-io-vtex-io-auth-and-policies.md) - Use when the main choice is which permissions and policies the chosen identity should carry
...
- [`vtex-io-data-access-patterns`](vtex-io-vtex-io-data-access-patterns.md) - Use when choosing where idempotency keys, sync state, or processing records should live
- [`vtex-io-observability-and-ops`](vtex-io-vtex-io-observability-and-ops.md) - Use when the main question is how async failures should be logged, measured, and monitored
...
- [`vtex-io-app-contract`](vtex-io-vtex-io-app-contract.md) — Manifest and builder configuration that GraphQL depends on
...
- [`vtex-io-events-and-workers`](vtex-io-vtex-io-events-and-workers.md) - Use when expensive or retry-prone work should move out of HTTP handlers into async flows
- [`vtex-io-auth-and-policies`](vtex-io-vtex-io-auth-and-policies.md) - Use when deciding which policies or access rules should protect HTTP routes
...
- [`vtex-io-data-access-patterns`](vtex-io-vtex-io-data-access-patterns.md) - Use when deciding between Master Data, VBase, VTEX core APIs, or external stores for a given dataset
...
- [`vtex-io-storefront-react`](vtex-io-vtex-io-storefront-react.md) - Use when the main question is storefront component structure and shopper-facing UI behavior
- [`vtex-io-admin-react`](vtex-io-vtex-io-admin-react.md) - Use when the main question is Admin UI structure and operational interaction patterns
- [`vtex-io-graphql-api`](vtex-io-vtex-io-graphql-api.md) - Use when the main question is GraphQL schema and resolver design rather than translation infrastructure
...
- [vtex-io-app-contract](vtex-io-vtex-io-app-contract.md) — Manifest, builders, and policy declarations
...
- [`vtex-io-storefront-theme-versioning`](vtex-io-vtex-io-storefront-theme-versioning.md) — Use when the app ships `store/contentSchemas.json` and a version change must preserve or migrate Site Editor content.
- [`vtex-io-storefront-theme-app`](vtex-io-vtex-io-storefront-theme-app.md) — Use when the question is how a consumer theme composes these blocks into pages.
...
- [`vtex-io-auth-and-policies`](vtex-io-vtex-io-auth-and-policies.md) - Use when the main decision is how route or resource access will be authorized
- [`vtex-io-auth-tokens-and-context`](vtex-io-vtex-io-auth-tokens-and-context.md) - Use when the main decision is which runtime identity should call VTEX endpoints
...
- [`vtex-io-render-runtime-and-blocks`](vtex-io-vtex-io-render-runtime-and-blocks.md) - Use when the main question is block registration and Store Framework wiring
- [`vtex-io-messages-and-i18n`](vtex-io-vtex-io-messages-and-i18n.md) - Use when the main question is how shopper-facing strings should be translated and organized
...
- [`vtex-io-storefront-theme-versioning`](vtex-io-vtex-io-storefront-theme-versioning.md) — Use when the question is how to safely change which version of this theme app is installed on `master`.
- [`vtex-io-render-runtime-and-blocks`](vtex-io-vtex-io-render-runtime-and-blocks.md) — Use when the question is how a block ID becomes a React component, or how a component app should declare blocks for themes to consume.
- [`vtex-io-storefront-react`](vtex-io-vtex-io-storefront-react.md) — Use when the question is the React implementation of a block, not its composition into pages.
- [`vtex-io-app-contract`](vtex-io-vtex-io-app-contract.md) — Use when the question is what the theme app's manifest contract should declare and how it interacts with base themes and component apps.
