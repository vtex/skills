...
- [`ki-specify`](known-issues-ki-specify.md) — Generate a full SDD specification document for a specific KI ticket
...
- [`ki-check`](known-issues-ki-check.md) — Look up open KIs for a repo or product area before deciding which one to spec
